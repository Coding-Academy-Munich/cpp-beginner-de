...
// %%
// Error: no matching function for call to 'distance(Point&, Point3d&)'
// distance(p21, p32)
...
// %% tags=["subslide"] slideshow={"slide_type": "subslide"}
void print_type_of(int i)
{
    std::cout << "int\n";
}

// %%
void print_type_of(double d)
{
    std::cout << "double\n";
}

// %% tags=["subslide"] slideshow={"slide_type": "subslide"}
void print_type_of(Point p)
{
    std::cout << "Point\n";
}

// %%
void print_type_of(Point3d p)
{
    std::cout << "Point3d\n";
}
